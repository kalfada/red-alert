...
interface AnimatedListProps {
    ...
    onItemSelect?: (item: string | ListItem, index: number) => void;
...
const AnimatedList: React.FC<AnimatedListProps> = ({
    ...
    defaultItemColor = "#111",
    defaultTextColor = "#ffffff",
    defaultSelectedColor = "#222",
}) => {
    ...
    const getItemData = (item: string | ListItem) => {
        ...
        return {
            ...
            selectedColor: item.selectedColor || item.color || defaultSelectedColor,
        };
    };
                ...
                {items.map((item, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                <p className="m-0" style={{ color: itemData.textColor }}>
                                    {itemData.text}
                                </p>
                            </div>
                        </AnimatedItem>
